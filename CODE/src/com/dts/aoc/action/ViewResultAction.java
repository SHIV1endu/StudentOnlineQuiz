...
HashMap hmpro=null;/*new AcceptTestNameDAO().getResult();*/
System.out.println("hm size-------"+hmpro.size());
...
String utype=(String) session.getAttribute("role");
System.out.println(utype);

String target;

if( utype.equals("ADMIN")){
	RequestDispatcher rd=request.getRequestDispatcher("/ViewResultstoadmin.jsp");
