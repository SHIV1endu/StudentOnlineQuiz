    ...
    <div style="width: 1000px; height: auto; margin-top: -15px;"></div>
			...
			<center>
		   	<div style="height: 350px; width: 500px; background-color: white;">
		   	       ...
		   	       <form action="./AddTestAction" method="get"  name="event1"
		   	      ...
		   	      <%
		   	       ...
		   	       <td style="color: #0000CD;">Enter Test Name</td><td><input type="text" name="testname" id="testname" style=" color: green; "/>
		   	    <label id="msgtestname"
		   	        ...
		   	        <tr>
		   	       <td style="color: #0000CD;">Enter Total Number of Question</td><td><input type="text" name="totalnoQuestion" value="20" id="totalnoQuestion" style=" color: green; " readonly="readonly"/>
		   	    <label id="msgmob"
											style="color: red; font-size: 16px; font-style: italic;"></label>
