...
<html>
  <head>
    ...
    <title>My JSP 'AcceptTestName.jsp' starting page</title>
  ...
  <div>
    ...
    new AcceptTestNameDAO().getAcceptTestName(tsno);
 
      session.setAttribute("acceptuser","Now Test Name Is Accepted");
